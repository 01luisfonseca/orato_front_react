export const Terms = () => {
  return (
    <div class="terms-container">
      ...
      <section class="mb-4">
        <h2 class="h5">2. Licencia para usar el sitio web</h2>
        <p>
          A menos que se indique lo contrario, nosotros o nuestros licenciantes
          poseemos los derechos de propiedad intelectual del sitio web y el
          material en el sitio web.
        </p>
      </section>

      <section class="mb-4">
        <h2 class="h5">3. Uso aceptable</h2>
        <p>
      ...
      <section class="mb-4">
        <h2 class="h5">4. Modificaciones</h2>
        <p>
